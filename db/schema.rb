...
ActiveRecord::Schema.define(version: 2020_11_17_122037) do
  ...
  create_table "genre_recommend_tags", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["genre_id"], name: "index_genre_recommend_tags_on_genre_id"
    t.index ["title"], name: "index_genre_recommend_tags_on_title"
  end
  ...
  create_table "recommend_articles", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "article_id", null: false
    t.integer "order_number", default: 0, null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["article_id"], name: "index_recommend_articles_on_article_id"
  end
  ...
  add_foreign_key "recommend_articles", "articles"
end
